async function trainNames(manager){
    ...
    const namesByGenderAndLanguageForBot = {
        'masculineEnglish': [
            "Abe", "Abraham", "Adrien", "Alan", "Albemarle", "Alex", "Alexander", "Alistair", "Almon", "Alton",
            "Alvy", "Amory", "Angus", "Arnaut", "Arnie", "Arnold", "Arthur", "Artie", "Ashley", "Aulay",
            "Auley", "Auliffe", "Awley", "Banastre", "Barron", "Barry", "Barton", "Basil", "Berry", "Bert",
    ...
    for (const [key, names] of Object.entries(namesByGenderAndLanguageForBot)) {
        manager.addNamedEntityText('botNamePerson', key, ['en'], names);
    } 
    ...
    manager.addDocument('en', "Your name is  %botName%", 'botName.userNamesBot');
    manager.addDocument('en', "You are %botName%", 'botName.userNamesBot');
    manager.addDocument('en', "Bot %botName% you", 'botName.userNamesBot');
    manager.addDocument('en', "You %botName%", 'botName.userNamesBot');
    manager.addDocument('en', "%botName%, suitable?", 'botName.userNamesBot');
    ...
    manager.addDocument('en', "Bot %botName%", 'botName.userNamesBot');
    manager.addDocument('en', "%botName% is what I'll call you", 'botName.userNamesBot');
    manager.addDocument('en', "You are now called %botName%", 'botName.userNamesBot');
    manager.addDocument('en', "Meet our new friend, %botName%", 'botName.userNamesBot');
    manager.addDocument('en', "Everyone, say hello to %botName%", 'botName.userNamesBot');
    manager.addDocument('en', "I think of you as %botName%", 'botName.userNamesBot');
